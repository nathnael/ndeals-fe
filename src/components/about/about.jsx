        ...
        <div className="main">
            ...
            <div className="page-content pb-0">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-5 mb-3 mb-lg-0">
                                ...
                                <a href="/blog/classic" className="btn btn-sm btn-minwidth btn-outline-primary-2">
                ...
                <div className="container">
                    ...
                    <OwlCarousel adClass="owl-simple" options={ mainSlider9 } slidesPerView={3} spaceBetween={30} navigate={false}>
                                ...
                                <figcaption className="member-overlay">
                                    <div className="member-overlay-content">
                                        ...
                                        <div className="social-icons social-icons-simple">
                                            <a href="/" className="social-icon" title="Facebook"><i className="icon-facebook-f"></i></a>
                                            <a href="/" className="social-icon" title="Twitter"><i className="icon-twitter"></i></a>
                                            <a href="/" className="social-icon" title="Instagram"><i className="icon-instagram"></i></a>
                                        </div>
                                    </div>
                                </figcaption>
                            </figure>
