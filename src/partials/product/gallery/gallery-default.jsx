            ...
            <div className={ `product-gallery ${adClass}` }>
                <div className="row m-0">
                    ...
                    <div id="product-zoom-gallery" className="product-image-gallery">
                        {
                            product.sm_pictures && product.sm_pictures.map( ( item, index ) =>
                                <button className={ `product-gallery-item ${0 === index ? 'active' : ''}` } key={ product.id + '-' + index } onClick={ e => changeBgImage( e, `${item.url}`, index ) }>
                                    <div className="img-wrapper h-100">
                                        <img src={ product.sm_pictures && product.sm_pictures[ index ].url } alt="product back" />
                                    </div>
                                </button>
                            )
                        }
